        ...
        {active === "dashboard" && (
          <section className="view-stack">
            <div className="metric-grid">
              ...
              <Metric label="Incident groups" value={summary?.incidentGroups ?? incidents.length} detail="DBSCAN correlation" tone="green" />
            ...
            return (
              <article className={index === 0 ? "history-card latest" : "history-card"} key={value(item, "_id", `${item.device_id}-${index}`)}>
                ...
                <div className="history-grid">
                  ...
                  <b>{String(item.correlation_verdict ?? "-")}</b>
                  <span>Real attack</span>
